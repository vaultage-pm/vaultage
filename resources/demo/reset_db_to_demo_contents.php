...
die("This function is disabled. Remove line 3 in reset_db_to_demo_contents.php to enable it.");
require("../config.php");
...
//insert default table, that contains some dummy ciphers encrypted with the pass "demo2"
